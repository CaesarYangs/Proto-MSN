...
SCRATCH_ROOT="res/dev_structured/spine_data/TEST/3_test_new_update_method"
# SCRATCH_ROOT="res/dev_structured/spine_data/TEST/000_dev_test_new_adaptative_update"
# SCRATCH_ROOT="res/dev_structured/spine_data/T1_Ultra_test(dynamic_classes)"
...
CONFIGS="configs/cityscapes/Proto_Med_Ultra.json"
CONFIGS_TEST="configs/cityscapes/Proto_Med_Ultra_TEST.json"

MODEL_NAME="hrnet_w48_proto_ultra_noval_update"
LOSS_TYPE="pixel_prototype_ce_loss_ultra"
