...
DATA_DIR="/DATA/yangyeqing/datasets/shenzhen_processed_resized_512square_format"
SAVE_DIR="/DATA/yangyeqing/Project-Brown/methods/protoseg_dev/res/coco_stuff_test4lung/test1/"
BACKBONE="hrnet48"
